...
/** SGK KHTN 9 – Kết nối tri thức (mạch Hóa: Chương 6–10, Bài 18–35) */
const lessons = [
  ["g9_b18", "Bài 18. Tính chất chung của kim loại", "Kim loại và phi kim", 1, 18, "Dẫn điện, dẫn nhiệt, có ánh kim; tính chất vật lí–hóa học chung.", "metal"],
  ["g9_b19", "Bài 19. Dãy hoạt động hóa học", "Kim loại và phi kim", 1, 19, "Thứ tự kim loại theo khả năng mất electron; phản ứng thế.", "activitySeries"],
  ["g9_b20", "Bài 20. Tách kim loại và hợp kim", "Kim loại và phi kim", 1, 20, "Luyện kim, tái chế; hợp kim thép, đồng thau và ứng dụng.", "alloy"],
  ["g9_b21", "Bài 21. Phi kim và kim loại", "Kim loại và phi kim", 1, 21, "So sánh tính chất; vai trò phi kim (C, S, P…) trong đời sống.", "nonmetal"],
  ...
  ["g9_b23", "Bài 23. Alkane", "Hữu cơ và hydrocarbon", 2, 23, "Ankan no CₙH₂ₙ₊₂; metan, etan; phản ứng cháy.", "alkane"],
  ...
  ["g9_b27", "Bài 27. Acetic acid", "Ethylic alcohol và acetic acid", 3, 27, "CH₃COOH: axit yếu, giấm, este hóa học đơn giản.", "acetic"],
  ["g9_b28", "Bài 28. Lipid", "Lipid, carbohydrate, protein, polymer", 4, 28, "Chất béo: cấu tạo, vai trò năng lượng và dinh dưỡng.", "lipid"],
  ["g9_b29", "Bài 29. Carbohydrate. Glucose và saccharose", "Lipid, carbohydrate, protein, polymer", 4, 29, "Glucose C₆H₁₂O₆, saccharose; phản ứng với Cu(OH)₂.", "glucose"],
...
const core = {
  g9_b18: ["Kim loại", "Dẫn điện tốt, dẻo (một số KL), dùng làm dây dẫn, nồi.", "Cu, Al, Fe ứng dụng rộng.", "Kim loại mất electron → ion dương."],
  g9_b19: ["Dãy hoạt động", "Kim loại đứng trước thế kim loại đứng sau trong dung dịch muối.", "Zn + CuSO₄ → ZnSO₄ + Cu.", "Không đặt K gần nguồn nước."],
  g9_b20: ["Hợp kim", "Hợp kim = kim loại + nguyên tố khác (thường là kim loại).", "Thép: Fe + C; đồng thau: Cu + Zn.", "Tính chất hợp kim khác kim loại gốc."],
  g9_b21: ["Phi kim – kim loại", "Phi kim: C, H, O, N, S…; kim loại: Cu, Fe, Al…", "Than (C) và đồng (Cu) khác nhóm tính chất.", "Sử dụng đúng vật liệu theo tính chất."],
  g9_b22: ["Hữu cơ", "Hợp chất hữu cơ có carbon (thường liên kết C–H).", "Dầu mỏ phân đoạn → xăng, dầu.", "Khác vô cơ: muối, nước không phải hữu cơ."],
  g9_b23: ["Alkane", "CₙH₂ₙ₊₂; CH₄ metan, C₂H₆ etan.", "CH₄ + 2O₂ → CO₂ + 2H₂O.", "Liên kết đơn C–C, C–H."],
  g9_b24: ["Alkene", "CₙH₂ₙ; có liên kết đôi C=C.", "C₂H₄ etilen dùng trong công nghiệp.", "Eten làm chín quả."],
  g9_b25: ["Nhiên liệu", "Than, dầu, khí thiên nhiên là nguồn hydrocarbon.", "Cháy tạo CO₂, H₂O và năng lượng.", "Tiết kiệm, giảm khí thải."],
  g9_b26: ["Ethylic alcohol", "C₂H₅OH tan trong nước; cháy được.", "Rượu có cồn; không uống khi học lab.", "Không đổ cồn gần lửa."],
  g9_b27: ["Acetic acid", "CH₃COOH; axit yếu; giấm ăn.", "CH₃COOH + NaOH → CH₃COONa + H₂O.", "Có mùi chua đặc trưng."],
  g9_b28: ["Lipid", "Chất béo: este của glyxerol và axit béo.", "Dầu ăn, mỡ động vật.", "Năng lượng dự trữ."],
  g9_b29: ["Glucose", "C₆H₁₂O₆ đường đơn; saccharose C₁₂H₂₂O₁₁.", "Phản ứng đặc trưng với Cu(OH)₂ (glucose).", "Carbohydrate cung cấp năng lượng."],
  g9_b30: ["Tinh bột – xenluloz", "Polime lớn từ đơn vị glucose.", "Tinh bột trong gạo; xenluloz trong gỗ, cotton.", "Iodine đổi màu với tinh bột."],
  g9_b31: ["Protein", "Chuỗi amino acid; enzyme là protein.", "Trứng, đậu giàu protein.", "Nhiệt cao làm biến tính protein."],
  g9_b32: ["Polymer", "Phân tử khổng lồ; PVC, PE, nylon.", "Túi nilon, ống PVC.", "Tái chế giảm rác thải nhựa."],
  g9_b33: ["Vỏ Trái Đất", "Si, O, Al, Fe… dạng silicate, oxide.", "Quặng sắt, bauxit nhôm.", "Khai thác bền vững."],
  g9_b34: ["Đá vôi – silicate", "CaCO₃ nung → CaO, xi măng.", "Thủy tinh, gốm từ silicate.", "CO₂ từ sản xuất vôi."],
  g9_b35: ["Carbon và khí hậu", "Chu trình carbon: CO₂ ↔ sinh vật ↔ nhiên liệu.", "Đốt nhiên liệu tăng CO₂ khí quyển.", "Giảm phát thải, trồng cây."]
};
...
const q = {
  ...
  g9_b24: [
    ...
    ["input", "Công thức etilen (C2H4) viết dạng không chỉ số dưới?", "C2H4", "Hoặc CH2=CH2 nhưng answer C2H4"]
  ],
  g9_b25: [
  ...
  g9_b34: [
    ...
    ["multiple_choice", "Xi măng liên quan nung:", ["CaCO3", "Muối", "Khí noble", "Glucose"], "CaCO3", "Sản xuất vôi."]
  ],
  g9_b35: [
...
console.log(`Grade 9 KNTT: ${grade9Skills.length} skills, ${grade9Questions.length} questions. Total: ${skills.length} skills.`);
