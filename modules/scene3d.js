...
const SCENE_GROUPS = {
  lab: ["khtn", "lab", "magnifier", "microscope", "length", "measure", "time", "temperature"],
  fluid: ["substances", "states", "oxygen", "materials", "fuels", "food", "mixture", "separation", "acid", "acidbase", "oxide", "salt", "fertilizer", "solution"],
  charge: ["atom", "periodic", "valence", "moleculeTypes", "bondIntro", "molecule", "ionic", "covalent"],
  circuit: ["reaction", "equationBalance", "stoichiometry", "catalyst", "mole"],
  magnet: ["metal", "activitySeries", "alloy", "nonmetal", "organic"],
  energy: ["alkane", "alkene", "alcohol", "acetic", "lipid", "glucose", "starch", "protein", "polymer", "carbonCycle"],
  pressure: ["earthCrust", "silicate"]
};
...
export const SCENE3D_CAPTIONS = {
  khtn: "Ba lĩnh vực KHTN — quan sát mô hình 3D",
  atom: "Mô hình nguyên tử — hạt nhân và electron",
  periodic: "Bảng tuần hoàn — các nguyên tố hóa học",
  molecule: "Phân tử 3D — liên kết hóa học",
  reaction: "Phản ứng hóa học — mô hình tương tác",
  acid: "Axit và bazơ trong không gian 3D",
  metal: "Kim loại và hợp kim",
  lab: "Phòng thí nghiệm Hóa học 3D"
};
